...
//                "{明确的数据分析结论、越详细越好，不要生成多余的注释}";
        ...
        Chart succeedStatus = new Chart();
        succeedStatus.setId(chart.getId());
        succeedStatus.setStatus("succeed");
        chartService.updateById(succeedStatus);
    ...
    private void handleChartUpdateError(long chartId, String execMessage) {
        ...
        boolean chartResult = chartService.updateById(chart);
        if (!chartResult) {
